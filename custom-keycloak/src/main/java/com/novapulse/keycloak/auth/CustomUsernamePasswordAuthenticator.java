...
public class CustomUsernamePasswordAuthenticator implements Authenticator {
    ...
    private static final Logger LOG = Logger.getLogger(CustomUsernamePasswordAuthenticator.class);
    ...
    private void handleCredentials(AuthenticationFlowContext context) {
        ...
        String otp = EmailOtpService.generateAndStore(context);
        EmailOtpService.sendOtpEmail(context.getSession(), realm, user, otp);
    ...
    private void handleOtpSubmission(AuthenticationFlowContext context) {
        ...
        EmailOtpService.ValidationResult result = EmailOtpService.validate(context, submittedOtp);
    ...
    private Response createLoginForm(AuthenticationFlowContext context, FormMessage error) {
        ...
        if (error != null)
            form.addError(error);
        return form.createForm("login.ftl");
    }
